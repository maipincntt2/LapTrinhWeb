									...
									<c:forEach items="${categoryList}" var="category"
										...
										<tr>
											...
											<td><a
												...
												class="btn btn-md btn-info"><i class="fa fa-list" aria-hidden="true"></i></a>
												<button type="button" class="btn btn-primary btn-danger"
													data-toggle="modal"
													data-target="#staticBackdrop-${Integer.toString(category.getId())}"><i class="fa fa-trash" aria-hidden="true"></i></button>
											</td>
