...
<body class="hold-transition sidebar-mini layout-fixed">
	<div class="wrapper">
		...
		<aside class="main-sidebar elevation-4" style = "background-color: #99FFFF">
			<a href="${pageContext.request.contextPath}/UserManual" class="brand-link"> <img
				src="Resources/img/adminlogo.png" alt="AdminLTE Logo"
				class="brand-image img-circle elevation-3" style="opacity: .8">
				<span class="brand-text font-weight-light" style = "color: #000">Quản lý thư viện</span>
			</a>
							...
							<ul class="nav nav-treeview">
								<li class="nav-item"><a
									...
									class="nav-link <c:if test="${sessionScope.Check.toString().equals('AddReader')}">active</c:if>">
										<i class="far fa-circle nav-icon"></i>
										<p style = "color: #000">Thêm phiếu mượn</p>
								</a></li>
								<li class="nav-item"><a
									...
									class="nav-link <c:if test="${sessionScope.Check.toString().equals('ManageReader_0')}">active</c:if>">
										<i class="far fa-circle nav-icon"></i>
										<p style = "color: #000">Danh sách mượn</p>
								</a></li>
								...
								<li class="nav-item"><a
									...
									class="nav-link <c:if test="${sessionScope.Check.toString().equals('ManageReader_1')}">active</c:if>">
										<i class="far fa-circle nav-icon"></i>
										<p style = "color: #000">Lịch sử mượn sách</p>
								</a></li>
							</ul></li>
