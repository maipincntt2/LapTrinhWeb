									...
									<c:forEach items="${bookList}" var="book" varStatus="loop">
										<tr>
											...
											<td><a
												...
												class="btn btn-sm btn-info" style="padding-bottom: 5px; padding-top: 3px; font-size: 14px; "><i class="fa fa-list" aria-hidden="true"></i></a>
												<button type="button" class="btn btn-primary btn-danger "
													data-toggle="modal"
													data-target="#staticBackdrop-${Integer.toString(book.getId())}"
													style="padding-bottom: 5px; padding-top: 3px; font-size: 14px; "><i class="fa fa-trash" aria-hidden="true"></i></button>	
											</td>
											...
											<div class="modal-dialog">
												<div class="modal-content">
													<div class="modal-header">
														<h5 class="modal-title" id="staticBackdropLabel1">Xác nhận xóa</h5>
